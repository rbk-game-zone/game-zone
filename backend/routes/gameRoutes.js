...
const { postScore, getAllScores } = require('../controllers/score.controller'); // Import score controller
...
// Score routes
router.post('/scores', postScore); // Route to post a new score
router.get('/scores', getAllScores); // Route to get all scores
